<?php
	...
	class Vequocte extends CI_Controller {
        ...
        $input = array();
        $input['where'] =array('catalog_news_id' => 24);
        ...
        $config['base_url']   = base_url('vequocte/index'); //link hien thi ra danh sach bài viết
        ...
        //lay danh sach bai viet ben phai
         $input1['where'] =array('catalog_news_id' => 24);
         $input1['limit'] = array(2,0);
         $news1= $this->news_model->get_list($input1);
        $this->data['news1'] = $news1;
        
        //load view
        $this->data['temp'] = 'site/vequocte/index';
        $this->load->view('site/vequocte/layout', $this->data);
		}
