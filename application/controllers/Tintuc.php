<?php 
    ...
    function khuyenmai()
    {
     ...
     function cactuyenbay()
    {
        $this->load->model('news_model');
        //lay tong so luong ta ca cac bai vai trong websit
        $input = array();
        $input['where'] =array('catalog_news_id' => 3);
        $total_rows = $this->news_model->get_total($input);
        ...
        //lay danh sach bai viet ben phai
         $input1['where'] =array('catalog_news_id' => 3);
         $input1['limit'] = array(2,0);
         $news1= $this->news_model->get_list($input1);
        $this->data['news1'] = $news1;
        
        //load view
        $this->data['temp'] = 'site/cactuyenbay/index';
        $this->load->view('site/cactuyenbay/layout', $this->data);
    }
    function view($id){
